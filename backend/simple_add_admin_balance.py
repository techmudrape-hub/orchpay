#!/usr/bin/env python3
"""
Simple script to add balance to admin wallet
Creates a direct credit transaction without needing PayIN
"""
import sys
import os
...
def add_admin_balance(target_amount):
    ...
    try:
        ...
        with conn.cursor() as cursor:
            ...
            # Create a simple PayIN transaction with minimal required fields
            ...
            """, (txn_id, order_id, amount_needed, amount_needed))
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python3 simple_add_admin_balance.py <target_amount>")
        print("Example: python3 simple_add_admin_balance.py 414530")
        sys.exit(1)
