...
Completely resets the database and creates admin user
"""
...
def reset_and_create_admin():
    ...
    try:
        print("=" * 80)
        print("Resetting Database and Creating Admin User")
        print("=" * 80)
        print()
        ...
        print("Step 2: Dropping and recreating database...")
        print(f"⚠️  WARNING: This will delete all data in '{Config.DB_NAME}'")
        ...
        if admin:
            ...
            print("=" * 80)
            print()
            print("⚠️  NOTE: You need to run 'python create_complete_database.py'")
            print("   to create all other required tables (merchants, transactions, etc.)")
            print()
            print("Or you can start the Flask app now and it will work for admin login,")
            print("but you'll need other tables for full functionality.")
            print()
        else:
...
if __name__ == '__main__':
    success = reset_and_create_admin()
